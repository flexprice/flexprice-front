	...
	return (
		<TooltipProvider delayDuration={0}>
			<Tooltip>
				...
				<TooltipContent
					sideOffset={5}
					className='bg-card border border-border shadow-lg text-sm text-foreground px-4 py-3 rounded-lg max-w-[300px]'>
					<div className='space-y-2'>
						<div className='font-medium text-foreground'>Price Override Applied</div>
