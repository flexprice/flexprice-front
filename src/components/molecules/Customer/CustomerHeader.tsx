	...
	return (
		<div className='items-center justify-center'>
			<div className='flex place-items-center space-x-3'>
				<span className='size-9 bg-contain rounded-md bg-gray-400 flex items-center justify-center text-content-inverse text-lg'>
					{customer?.name
						?.split(' ')
				...
				<div className='flex flex-col'>
					<div className='flex items-center gap-2'>
						<div className='text-xl font-normal text-content-heading'>{customer?.name}</div>
