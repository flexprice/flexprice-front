		...
		<Popover>
			<PopoverTrigger asChild>
				<Button variant='outline' size='icon' aria-label={ariaLabel} className='relative h-9 w-9'>
					...
					{activeFilterCount > 0 ? (
						<span className='absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-zinc-900 px-1 text-[10px] font-medium text-content-inverse'>
							{activeFilterCount}
						</span>
					) : null}
				</Button>
