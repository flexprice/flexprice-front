...
export const PremiumFeatureTag = () => {
	return (
		<div className='flex gap-2 top-2 right-2 items-center justify-center  text-warning-muted-foreground text-xs !font-semibold px-2 py-1 rounded-2xl !opacity-80'>
