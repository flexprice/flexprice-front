...
const PhaseForm: React.FC<PhaseFormProps> = ({
	...
	return (
		<div className='space-y-6 p-6 border border-line rounded-lg bg-surface shadow-sm'>
			{/* Phase Dates */}
			<div>
				<h4 className='text-sm font-semibold text-content mb-4'>{t('organisms.phaseForm.phaseDuration')}</h4>
