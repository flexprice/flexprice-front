/*
 * Dark counterparts for the three marks whose brand colour is a deep navy. Razorpay, HubSpot and
...
export type Integration = {
	/** Route segment and connection API key, e.g. `stripe`, `zoho` (not localized). */
	id: string;
	name: string;
	description: string;
	logo: string;
	/** Optional dark-theme mark. Falls back to `logo` when a brand reads fine on dark. */
	logoDark?: string;
	tags: string[];
	/** Machine tag keys (e.g. `dataPipelines`) for filtering; not shown in UI. */
	tagKeys: string[];
	websiteUrl?: string;
	docsUrl?: string;
	premium?: boolean;
...
export type IntegrationCatalogSpec = Pick<
	Integration,
	'id' | 'logo' | 'logoDark' | 'websiteUrl' | 'docsUrl' | 'premium' | 'type' | 'accountId' | 'apiKey' | 'installedAt'
> & {
	tagKeys: string[];
	/** i18n key suffix under `insightsTools.integrations.catalog.mode.*` */
	modeKey?: 'test';
	/** Ordered section keys under `insightsTools.integrations.catalog.<id>.sections.<key>` */
	sectionKeys?: readonly string[];
};

export const integrationCatalogSpecs: IntegrationCatalogSpec[] = [
	{
		id: 'stripe',
		...
		sectionKeys: ['overview', 'stripeInvoicing', 'automaticTax', 'securePayments'],
	},
	{
		id: 'razorpay',
		...
		logoDark: razorpayDark,
		tagKeys: ['payments', 'invoices'],
		type: 'available',
		sectionKeys: ['overview', 'razorpayInvoicing', 'automaticTax', 'securePayments'],
	},
	{
		id: 'chargebee',
		...
		tagKeys: ['payments', 'invoices'],
		type: 'available',
		sectionKeys: ['overview', 'invoiceSync', 'chargePriceSync'],
	},
	{
		id: 'hubspot',
		websiteUrl: 'https://hubspot.com',
		logo: 'data:image/svg+xml;base64,',
		logoDark: hubspotDark,
		tagKeys: ['crm', 'sales', 'marketing', 'customerService'],
		type: 'available',
		sectionKeys: ['overview', 'dealLineItems', 'invoiceSync', 'customerSync', 'paymentsSync', 'revenueReporting'],
	},
	{
		id: 'salesforce',
		logo: 'https://upload.wikimedia.org/wikipedia/commons/f/f9/Salesforce.com_logo.svg',
		tagKeys: ['crm', 'accounting'],
		premium: true,
		type: 'available',
	},
	{
		...
		tagKeys: ['payment', 'invoiceCustomer'],
		premium: true,
		type: 'available',
	},
	{
		...
		tagKeys: ['accounting', 'invoices'],
		type: 'available',
		sectionKeys: ['createCustomer', 'createInvoice', 'transformInvoice'],
	},
	{
		id: 'quickbooks',
		...
		tagKeys: ['accounting', 'invoices'],
		type: 'available',
		sectionKeys: ['overview', 'planPriceSync', 'customerSync', 'invoiceSync', 'tokenRefresh'],
	},
	{
		id: 'nomod',
		...
		tagKeys: ['payments', 'invoices'],
		type: 'available',
		sectionKeys: ['overview', 'invoiceSync', 'paymentLinks', 'webhooks'],
	},
	{
		id: 'moyasar',
		docsUrl: 'https://docs.flexprice.io/integrations/moyasar/',
		logo: '/assets/logo/moyasarlogo.svg',
		logoDark: moyasarDark,
		tagKeys: ['payments', 'invoices'],
		type: 'available',
		sectionKeys: ['overview', 'invoiceSync', 'securePayments', 'webhooks'],
	},
	{
		id: 'paddle',
